...
export const AI_USAGE_FEATURE_LABELS: Record<string, string> = {
  ...
  script_writer_references: "Script writer — comparable films",
  script_writer_ideas: "Script writer — idea spark",
  script_writer_storyboard: "Script writer — storyboard images",
