...
Simple one-line workflow: Start with story emotion, choose the motivated light source, remove bad light, set camera and white balance, build the key, shape the shadows, add separation, control the background, test the image, then roll.`,
    ...
    {
      id: "practical-light-colors",
      category: "lighting",
      title: "Common light source colors (CCT)",
      summary: "Kelvin targets for sunlight, moonlight, street lights, cars, and everyday practicals.",
      body: `Color temperature (CCT) is measured in Kelvin (K). Lower numbers look warm (amber); higher numbers look cool (blue). Mixed sources are normal — meter each source and decide whether to match, gel, or lean into the contrast.

These are typical ranges, not laws. LED retrofits, age, pollution, and camera WB shift what you see. Always meter on set.`,
      tables: [
        {
          headers: ["Source", "Typical CCT", "Color character", "On-set notes"],
          rows: [
            ["Direct sunlight (midday)", "5200–5800K", "Neutral white", "Hard, high contrast — use diffusion or shoot open shade"],
            ["Open shade / north sky", "7000–9000K", "Cool blue ambient", "Soft fill outdoors; great for clean skin with warm rim"],
            ["Golden hour sun", "3000–4500K", "Warm gold", "Long shadows; skin glows — expose for highlights"],
            ["Blue hour (twilight sky)", "9000–12000K", "Deep cool blue", "Low level — plan ISO, noise, and stabilization"],
            ["Overcast / heavy cloud", "6500–7500K", "Soft cool daylight", "Flat but flattering; add negative fill for shape"],
            ["Moonlight (real)", "4100K+ (very dim)", "Not actually blue", "Film \"moonlight\" is a look — usually simulated cooler"],
            ["Moonlight (cinematic look)", "3200K + full CTB or 5600K + CTB", "Blue, low level", "Underexpose 2–4 stops; hard rim or soft top; avoid filling shadows"],
            ["Tungsten bulb / lamp", "2700–3200K", "Warm amber", "Classic interior; dims warmer when dimmed"],
            ["Halogen", "3000–3200K", "Warm white", "Slightly cleaner than tungsten; still very warm"],
            ["Candle / firelight", "1800–2500K", "Deep orange", "Flicker + warm falloff; expose for face near flame"],
            ["Sodium-vapor street light", "1700–2200K", "Orange-monochrome", "Very warm; poor CRI — skin goes muddy without correction"],
            ["Modern LED street light", "3000–5000K", "Warm to neutral white", "Check flicker with LIT DUO; color varies by city"],
            ["Car headlight (halogen)", "3200K", "Warm white beam", "Hard, directional; watch flare and exposure spikes"],
            ["Car headlight (HID / xenon)", "4300–6000K", "Cool white-blue", "Reads \"modern car\" — cooler than tungsten practicals"],
            ["Car headlight (LED)", "5500–6500K", "Cool white", "Very common on new cars; check PWM flicker"],
            ["Fluorescent / office tube", "3500–4100K", "Green-magenta cast", "Often green spike — plus green or adjust tint in post"],
            ["Neon sign", "Varies by gas", "Saturated color", "Not a single CCT — meter hue; often blows highlights"],
            ["TV / monitor / projector", "~6500K (D65 target)", "Cool white glow", "Expose for screen content; check refresh flicker"],
            ["Phone / tablet screen", "~6500–7500K", "Cool white", "Small source — close falloff; can motivate face in dark scenes"],
            ["Flashlight (LED)", "5000–6500K", "Cool white", "Hard beam; battery dimming shifts color and flicker"],
            ["Emergency vehicle lights", "Red / blue (not CCT)", "Saturated", "Sodium/LED ambient still sets the base WB"],
          ],
        },
        {
          headers: ["If you want this feel", "Starting WB", "Quick cheat"],
          rows: [
            ["Warm cozy interior", "3200K", "Tungsten practicals + amber bounce"],
            ["Neutral documentary", "4300–5600K", "Match dominant window or key"],
            ["Cool night exterior", "5600K + CTB on key", "Keep shadows deep; cool rim only"],
            ["Mixed bar / street at night", "3200–4300K", "Pick hero source (window, neon, street) and gel others toward it"],
            ["Horror screen glow", "5600K camera", "Let screen/practical clip slightly; cool fill minimal"],
          ],
        },
      ],
      tips: [
        "Mixed color is realistic — match what the audience should believe is \"white,\" not every bulb in frame",
        "Sodium street + tungsten interior = strong orange outside / warm inside — great for contrast",
        "Car headlights at night: expose for face first; let beams bloom unless plate is critical",
        "When in doubt: meter CCT on the LIT DUO, set manual WB, shoot a 10-second test",
      ],
    },
    {
      id: "color-wheel",
