...
export const BUILTIN_TEMPLATES: TemplateCatalogEntry[] = [
  ...
  {
    id: "talent_agreement",
    name: "Talent Agreement & Release",
    type: "talent_agreement",
    description: "Actor/talent participation plus name, image, likeness, and performance release",
  ...
  },
  {
    ...
    description: "Crew deal memo — role, dates, rate, overtime, kit rental, credits, W-9, work-for-hire",
  ...
  },
  {
    ...
    name: "Location Agreement & Release",
    type: "location_agreement",
    description: "Film location permission, safe access, fees, damage, liability, and depiction rights",
