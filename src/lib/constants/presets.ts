...
export const EQUIPMENT_CATALOG_PRESETS = [
  ...
  { name: "Sirui VP-1 15mm T1.6 Cine", category: "Lens", brand: "Sirui", model: "VP-1 15mm T1.6", dailyRate: 45, weeklyRate: 135, replacementValue: 649, active: true },
  { name: "Sirui VP-1 24mm T1.4 Cine", category: "Lens", brand: "Sirui", model: "VP-1 24mm T1.4", dailyRate: 45, weeklyRate: 135, replacementValue: 649, active: true },
  { name: "Sirui VP-1 35mm T1.4 Cine", category: "Lens", brand: "Sirui", model: "VP-1 35mm T1.4", dailyRate: 45, weeklyRate: 135, replacementValue: 649, active: true },
  { name: "Sirui VP-1 50mm T1.4 Cine", category: "Lens", brand: "Sirui", model: "VP-1 50mm T1.4", dailyRate: 45, weeklyRate: 135, replacementValue: 649, active: true },
  { name: "Sirui VP-1 75mm T1.4 Cine", category: "Lens", brand: "Sirui", model: "VP-1 75mm T1.4", dailyRate: 45, weeklyRate: 135, replacementValue: 649, active: true },
  { name: "Sirui VP-1 150mm T4 Macro Cine", category: "Lens", brand: "Sirui", model: "VP-1 150mm T4 Macro", dailyRate: 50, weeklyRate: 150, replacementValue: 649, active: true },
  { name: "DJI RS 3 Pro Gimbal", category: "Support", brand: "DJI", model: "RS 3 Pro", dailyRate: 65, replacementValue: 1100, active: true },
  { name: "Tilta Nucleus-M II Ultimate Kit", category: "Support", brand: "Tilta", model: "WLC-T06", dailyRate: 85, weeklyRate: 255, replacementValue: 1499, active: true },
