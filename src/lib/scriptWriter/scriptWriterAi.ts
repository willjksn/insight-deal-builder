      ...
      ? [
          {
            ...
            description: "Wide establishing shot; subject enters frame left third; environment readable in BG.",
            subjectAction: "Subject walks in and settles into frame.",
            cameraMovement: "static on sticks",
            lens: "24mm",
            framing: "WS, subject screen-left, lead room screen-right",
            cameraHeight: "eye level, ~5'6\" lens height",
            blocking: "Subject enters from camera-left; key set dressing deep BG",
            lighting: "Natural window key camera-right; bounce fill camera-left; ratio ~3:1",
            exposureNotes: "24p 1/50, T4, EI 400, skin ~50 IRE",
            audioNotes: "MOS; capture 30 sec room tone after scene",
            setupNotes: "Lock off; slate scene 1 / shot 1",
            purpose: "Establish place and tone before story beat",
            duration: "4–6 sec",
          },
          {
            sceneNumber: "1",
