...
4. When scripting can talk to Resolve: timeline is imported automatically.
...
| `POST /v1/resolve/import-edl` | `ImportTimelineFromFile` via official API |
